...
import {setDepth_data, setDepth1, setDepth2, setDepth3} from "../../store/WorkSlice.jsx";
              ...
              <div className='desc'>
                {
                    state_work.depth_data && state_work.depth_data.map((one)=>{
                        return(
                            <div onClick={()=>{
                              if(props.data==1){dispatch(setDepth1(one.code)); openModalHandler2();}
                              else if(props.data==2){dispatch(setDepth2(one.code)); openModalHandler2();}
                              else if(props.data==3){dispatch(setDepth3(one.code)); openModalHandler2();}
